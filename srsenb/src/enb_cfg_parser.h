...
int parse_sib10(std::string filename, asn1::rrc::sib_type10_s* data);    // panic attack
int parse_sib11(std::string filename, asn1::rrc::sib_type11_s* data);    // panic attack
int parse_sib12(std::string filename, asn1::rrc::sib_type12_r9_s* data); // panic attack
